...
```csharp 
 public static void Main(string[] args)
 {
     ...
     Console.WriteLine(ProcessHandle.get_current_process_handle());
     ...
     pipe.write(message_write, (size_t)message_write.Length * sizeof(byte), 0, "");

     byte[] message_read = new byte[32];
     pipe.read(message_read, (size_t)message_write.Length * sizeof(byte), 0, "");
